...
| **Measurement** | 17 benchmarks, an eval harness with a frozen reference run, 1747 tests | [8](#8-how-to-verify-any-claim-here) |
...
```bash
npm test                                    # the runner counts subtests; static count 1747
