...
| **Measurement** | 17 benchmarks, an eval harness with a frozen reference run, 1384 tests | [8](#8-how-to-verify-any-claim-here) |
...
```bash
npm test                                    # 1389 tests (the runner counts subtests; static count 1384)
